const theme_switcher = document.querySelector("#theme_switcher");

// =================== this is a automatic select theme script  =====================
...
// =================== this is a automatic select theme part depend on time  =====================
...
// ================================== this is a select theme part ==================================

const default_theme = localStorage.getItem("theme") || "theme_light";
setTheme(default_theme);

theme_switcher.addEventListener("change", (e) => {
  setTheme(e.target.value || "theme_light");
});
